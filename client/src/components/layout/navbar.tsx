        ...
        <div className="flex items-center gap-8">
          <Link href="/">
            <a className="flex items-center gap-2">
              <img src="/logo.svg" alt="HandSpeak Innovators" className="h-8 w-8" />
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/explore">
              <a className="text-sm font-medium hover:text-primary">Explore</a>
            </Link>
            <Link href="/my-learning">
              <a className="text-sm font-medium hover:text-primary">My Learning</a>
            </Link>
          </div>
        </div>
