        ...
        {isLoading ? (
          ...
          <Tabs defaultValue="all" className="space-y-8">
            ...
            <TabsContent value="asl">
              <div>
                <h3 className="text-2xl font-bold text-center mb-8">American Sign Language Courses</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <TabsContent value="bsl">
              <div>
                <h3 className="text-2xl font-bold text-center mb-8">British Sign Language Courses</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <TabsContent value="isl">
              <div>
                <h3 className="text-2xl font-bold text-center mb-8">Indian Sign Language Courses</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
